...
public class AwsLogs {
    ...
    public static void main(String[] args) {
        try{
            ...
            Document result = logCollection.find(filter).first();
            if(result != null){
                System.out.printf("몽고db검색결과>> " + result.toJson());
            }
